...
Puisque le test n'est pas significatif,Réalison un test de Kruskal.
```{r }
...
testing <- prevision[1:nrow(prevision)*0.80,]
...
(et toutes très mauvaise pour le sur-lendemain)
