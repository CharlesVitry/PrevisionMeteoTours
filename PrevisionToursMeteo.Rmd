...
reg.mul <- lm(TempÃ.rature~.,prevision)
shapiro.test(reg.mul$residuals)

```
Avec des résidus non gaussiens , un R² de 1 est inutile
![Rcarre.png](Rcarre.png)
...
Réalisons les intervalles de confiance et l'histogramme
```{r}
confint(reg.mul)
